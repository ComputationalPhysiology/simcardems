...
class LandModel(pulse.ActiveModel):
    def __init__(
        ...
        **kwargs,
        ...
        self.update_prev(include_state=False)

    def register_state(self, state):
        self.state = state
        self.state_ = dolfin.Function(state.function_space())
    ...
    def Ta(self, F):
        s_split = dolfin.as_vector(dolfin.split(self.state))
