...
To get an overview of the project, read the [documentation](https://computationalphysiology.github.io/simcardems/). Here are some resources to help you get started with open source contributions:
